                ...
                <div className="dashboard-main-body">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 border-s-neutral-300">
                                            <div className="card-body p-6 h-full flex flex-col border-b sm:border-r border-neutral-200 dark:border-neutral-600">
                                                ...
                                                <p className="text-sm mb-0 mt-3">
                                                    Increase by{" "}
                                                    <span className="bg-success-100 dark:bg-success-600/25 px-1 py-0.5 rounded-sm font-medium text-success-600 dark:text-success-500 text-sm">
                                                        +200
                                                    </span>{" "}
                                                    this week
                                                </p>
                                            ...
                                            <div className="card-body p-6 h-full flex flex-col border-b border-neutral-200 dark:border-neutral-600">
                                                ...
                                                <p className="text-sm mb-0 mt-3">
                                                    Increase by{" "}
                                                    <span className="bg-danger-100 dark:bg-danger-600/25 px-1 py-0.5 rounded-sm font-medium text-danger-600 dark:text-danger-500 text-sm">
                                                        -5k
                                                    </span>{" "}
                                                    this week
                                                </p>
                            ...
                            <div className="card h-full rounded-lg border-0">
                                <div className="card-body p-6">
                                    ...
                                    <div className="relative">
                                        <span className="w-[80px] h-[80px] bg-white dark:bg-neutral-700 shadow-lg text-neutral-600 dark:text-neutral-200 font-semibold text-xl flex justify-center items-center rounded-full absolute end-0 top-0 z-1">
                                            +30%
                                        </span>
                                        <div
                                    ...
                                    <div className="mt-8">
                                        <div className="flex items-center justify-between gap-3 mb-5">
                                            <div className="flex items-center gap-2">
                                                ...
                                                />
                                                <div className="grow">
                                                    <h6 className="text-base mb-0 font-normal">Paytm</h6>
                                        ...
                                        <div className="flex items-center justify-between gap-3 mb-5">
                                            ...
                                            <span className="text-success-600 text-base font-medium">
                                                +$800
                                            </span>
                                        </div>
                                        <div className="flex items-center justify-between gap-3 mb-5">
                                            <div className="flex items-center gap-2">
                                                ...
                                                />
                                                <div className="grow">
                                                    <h6 className="text-base mb-0 font-normal">Stripe</h6>
                                                    <span className="text-sm text-secondary-light font-normal">
                                                        Ordered iPhone 14
                                                    </span>
                                                </div>
                                            </div>
                                            <span className="text-danger-600 text-base font-medium">
                                                -$300
                                            </span>
                                        </div>
                                        <div className="flex items-center justify-between gap-3 mb-5">
                                            <div className="flex items-center gap-2">
                                                ...
                                                />
                                                <div className="grow">
                                                    <h6 className="text-base mb-0 font-normal">Razorpay</h6>
                                                    <span className="text-sm text-secondary-light font-normal">
                                                        Refund
                                                    </span>
                                                </div>
                        ...
                        <div className="md:col-span-12 lg:col-span-6 2xl:col-span-4">
                            <div className="card h-full border-0 rounded-lg">
                                <div className="card-body p-6">
                                    <h6 className="mb-3 font-bold text-lg">Recent Orders</h6>
                                    <div className="flex items-center gap-2">
                                        <h6 className="font-semibold mb-0">$27,200</h6>
                                        <p className="text-sm mb-0">
                                            <span className="bg-success-600/20 border border-success-600/25 px-2 py-1 rounded-full font-semibold text-success-600 dark:text-success-400 text-sm inline-flex items-center gap-1">
                                                10%
                                            </span>
                                            Increases
                                        </p>
                                    </div>
                                    <div id="recent-orders" className="mt-7" />
                                </div>
                            </div>
                        </div>
                        <div className="md:col-span-12 lg:col-span-6 2xl:col-span-4">
                            <div className="card rounded-lg border-0">
                                ...
                                <div
                                    id="world-map"
                                    className="h-[200px] bg-neutral-100 dark:bg-neutral-600/30"
                                />
                                        ...
                                        <div className="flex items-center justify-between gap-3 mb-3 pb-2">
                                            ...
                                            <div className="flex items-center gap-2 w-full">
                                                <div className="w-full max-w-66 ms-auto">
                                                    <div
                                                        className="progress progress-sm rounded-full"
                                                        role="progressbar"
                                                    ...
                                                    >
                                                        <div
                                                            className="progress-bar bg-primary-600 rounded-full"
                                                            style={{ width: "80%" }}
                                                        />
                                                    </div>
                                                </div>
                                                <span className="text-secondary-light font-xs font-semibold">
                                                    80%
                                                </span>
                                            </div>
                                        </div>
                                        <div className="flex items-center justify-between gap-3 mb-3 pb-2">
                                            ...
                                            <div className="flex items-center gap-2 w-full">
                                                <div className="w-full max-w-66 ms-auto">
                                                    ...
                                                    >
                                                        <div
                                                            className="progress-bar bg-orange rounded-full"
                                                            style={{ width: "60%" }}
                                                        />
                                                    </div>
                                                </div>
                                        ...
                                        <div className="flex items-center justify-between gap-3 mb-3 pb-2">
                                            ...
                                            <div className="flex items-center gap-2 w-full">
                                                <div className="w-full max-w-66 ms-auto">
                                                    ...
                                                    >
                                                        <div
                                                            className="progress-bar bg-warning-600 rounded-full"
                                                            style={{ width: "49%" }}
                                                        />
                                                    </div>
                                                </div>
                                        ...
                                        <div className="flex items-center justify-between gap-3">
                                            ...
                                            <div className="flex items-center gap-2 w-full">
                                                <div className="w-full max-w-66 ms-auto">
                                                    ...
                                                    >
                                                        <div
                                                            className="progress-bar bg-success-600 rounded-full"
                                                            style={{ width: "100%" }}
                                                        />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="mt-8">
                                        ...
                                        <div className="flex items-center justify-between gap-3">
                                            <div className="flex items-center gap-2">
                                                ...
                                                />
                                                <div className="grow">
                                                    <h6 className="text-base mb-0 font-normal">John Doe</h6>
                                                    <span className="text-sm text-secondary-light font-normal">
                                                        017******58
                                                    </span>
                                                </div>
                        ...
                        <div className="md:col-span-12 2xl:col-span-6">
                            <div className="card h-full border-0">
                                <div className="card-body p-6">
                                    <div className="flex items-center flex-wrap gap-2 justify-between mb-5">
                                        <h6 className="mb-2 font-bold text-lg mb-0">
                                            Top Selling Product
                                        </h6>
                                        <a
                                            href="javascript:void(0)"
                                        ...
                                        <table className="table bordered-table mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div className="flex items-center">
                                                            <img
                                                                ...
                                                                alt=""
                                                                className="shrink-0 me-3 rounded-lg me-3"
                                                            />
                                                            <div className="grow">
                                                                <h6 className="text-base mb-0 font-normal">
                                                                    Blue t-shirt
                                                    ...
                                                    <td>300</td>
                                                    <td className="text-center">
                                                        <span className="bg-success-100 dark:bg-success-600/25 text-success-600 dark:text-success-400 px-8 py-1.5 rounded-full font-medium text-sm">
                                                            70
                                                        </span>
                                                    </td>
                                                </tr>
                        ...
                        <div className="md:col-span-12 2xl:col-span-6">
                            <div className="card h-full border-0">
                                <div className="card-body p-6">
                                    ...
                                    <div className="table-responsive scroll-sm">
                                        <table className="table bordered-table mb-0 style-two">
                                            <thead>
                                                <tr>
                                                    <th scope="col">Items</th>
                                                    <th scope="col">Price</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div className="max-w-[44px]2 mx-auto">
                                                            ...
                                                            <span className="mt-3 text-secondary-light text-sm font-medium">
                                                                Out of Stock
                                                            </span>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div className="max-w-[44px]2 mx-auto">
                                                            <div className="w-full">
                                                                ...
                                                                >
                                                                    <div
                                                                        className="progress-bar bg-danger-600 rounded-full"
                                                                        style={{ width: "40%" }}
                                                                    />
                                                                </div>
                                                            </div>
